...
|------|-------|---------|---------|
| [ci-cd-deployment-pipeline](ci-cd-deployment-pipeline.md) | CI/CD & Deployment Pipeline | Automated build, test, and deployment pipeline for the home network | 2026-04-17 |
