...
public class PasswordHasherTests
{
	...
	public void VerifyPassword_ShouldReturnTrue_ForCorrectPassword()
	{
		...
		Assert.That(_hasher.VerifyPassword(password, hash), Is.True);
	}
	...
	public void VerifyPassword_ShouldReturnFalse_ForWrongPassword()
	{
		...
		Assert.That(_hasher.VerifyPassword("WrongPassword", hash), Is.False);
	}
	...
	{
		Assert.That(_hasher.VerifyPassword(password, hash), Is.False);
	}
}